const Projects=[
    {
        ...
        description:"An app that can be used it keep track of a game of disc golf.  It is build with Angular, Express, and MongoDB",
        url:"https://github.com/Noswad123/breaking-chains",
        status:"See in git hub",
        imgUrl:"./img/breakin_chains.png"
    },
    {
        name:"Cartoon Cars",
        description:"First react app, so I'm having fun experimenting with its features.  In this app, You may view a gallery of fantasy cars.",
        url:"http://cartoon-car.herokuapp.com/",
        status:"Always tinkering. Load times can be long on the Heroku site. Please be patient.",
