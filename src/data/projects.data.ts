export const Projects = [
  {
    ...
    description:
      "An app that can be used it keep track of a game of disc golf. Users are also able to manage their collection of discs.",
    url: "https://breaking-chains.herokuapp.com/login",
    tech: [
      "./img/html.png",
      "./img/sass.png",
      "./img/angular.svg",
